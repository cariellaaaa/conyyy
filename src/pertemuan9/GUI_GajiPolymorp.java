...
public class GUI_GajiPolymorp extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        txt_hobby = new javax.swing.JTextField();
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            .addComponent(txt_gatot, javax.swing.GroupLayout.DEFAULT_SIZE, 120, Short.MAX_VALUE)
                            .addComponent(txt_jabatan, javax.swing.GroupLayout.DEFAULT_SIZE, 120, Short.MAX_VALUE)
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGap(16, 16, 16)
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(txt_hobby, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(jLabel9))
                .addContainerGap())
        );
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        int lbr = Integer.parseInt(txt_lembur.getText());
        switch (cmbPegawai.getSelectedIndex()) {
            case 0 : {
                ...
                txt_hobby.setText(objKaryawan.Memasak());

            }
            case 1 : {
                gaji = new Sekretaris();
                Sekretaris objSekre = (Sekretaris) gaji;
                objSekre.jmlhHadir = hdr;
                txt_jabatan.setText(gaji.Pegawai(objSekre));
                txt_gatot.setText(Integer.toString(gaji.hitGaji()));
                txt_hobby.setText(objSekre.menari());

            }
            default : {
                gaji = new Manager();
                Manager objManager = (Manager) gaji;
                objManager.jmlhHadir = hdr;
                objManager.jmlhLembur = lbr;
                txt_jabatan.setText(gaji.Pegawai(objManager));
                txt_gatot.setText(Integer.toString(gaji.hitGaji()));
                txt_hobby.setText(objManager.Memasak() + " dan " + objManager.menari());
            }
          }
        }
            catch(NumberFormatException e){
                JOptionPane.showMessageDialog(this, "Masukkan Jumlah Lembur", "Error",  JOptionPane.ERROR_MESSAGE);
                    } 
            catch(Exception e){
    ...
    private javax.swing.JTextField txt_hobby;
